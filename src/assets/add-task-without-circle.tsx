...
const AddTaskWithoutCircle = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg
...
const ForwardRef = forwardRef(AddTaskWithoutCircle)
const Memo = memo(ForwardRef)

export { Memo as AddTaskWithoutCircle }